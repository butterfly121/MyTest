 ...
 */
public class CreateZishe extends driverBase {
//    private WebDriver driver;
    ...
    public void setUp() throws Exception {
        ...
        createPage.findFrame(Loginpage.getElement.ORG1_XPATH,Loginpage.getElement.ORG1_FRAME_XPATH,true);
    }
    @DataProvider(name = "final1")
    public Object[][] Createfinal() throws IOException, JXLException {
        ParseExcel peLogin = new ParseExcel("/Users/xhm/Desktop/2017周报/createcustomer.xls","新建咨设机构");
    ...
    public void CreateOrgani() throws Exception{
        ...
        createPage.CreateCustom1("咨设机构","缓存机构",Loginpage.getElement.ORG1_FRAME_XPATH,"新建咨设机构");
    }
    @AfterClass
