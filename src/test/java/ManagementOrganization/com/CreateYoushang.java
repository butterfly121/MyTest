...
/**
 * Created by xhm on 2017/7/3.
 */
public class CreateYoushang extends driverBase {
//    private WebDriver driver;
    ...
    public void setUp() throws Exception {
        ...
        createPage.findFrame(Loginpage.getElement.ORG3_XPATH,Loginpage.getElement.ORG3_FRAME_XPATH,true);
    }
    @DataProvider(name = "final1")
    public Object[][] Createfinal() throws IOException, JXLException {
        ParseExcel peLogin = new ParseExcel("/Users/xhm/Desktop/2017周报/createcustomer.xls","新建上下友商");
    ...
    public void CreateOrgani() throws Exception{
        ...
        createPage.CreateCustom1("友商","缓存上下友商",Loginpage.getElement.ORG3_FRAME_XPATH,"新建上下友商");
    }
    @AfterClass
