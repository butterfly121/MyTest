 ...
 */
public class CreateDaili extends driverBase {
//    private WebDriver driver;
    ...
    public void setUp() throws Exception  {
        ...
        createPage.findFrame(Loginpage.getElement.ORG2_XPATH,Loginpage.getElement.ORG2_FRAME_XPATH,true);
    }
    @DataProvider(name = "final1")
    public Object[][] Createfinal() throws IOException, JXLException {
        ParseExcel peLogin = new ParseExcel("/Users/xhm/Desktop/2017周报/createcustomer.xls","新建招标代理");
    ...
    public void CreateOrgani() throws Exception{
        ...
        createPage.CreateCustom1("代理","缓存代理",Loginpage.getElement.ORG2_FRAME_XPATH,"新建招标代理");
    }
    @AfterClass
